namespace azara.models.Responses.POSStore
{
    public class POSStoreGetByIdResponse
    {
        ...
        public List<POSStoreGetListResponse> StoreList { get; set; }
    }

    public class POSStoreGetListResponse
    {
        public string Name { get; set; }
