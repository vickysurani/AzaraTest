...
namespace azara.api.Controllers
{
    ...
    public class AboutUsController : BaseController
    {
        ...
        public async Task<IActionResult> AboutUsGetListAsync([FromBody] AboutUsInsertRequest request)
        {
            if (!ModelState.IsValid)
                return ErrorResponse(ModelState);
        ...
        public async Task<IActionResult> AboutUsDeleteAsync([FromBody] AboutUsDeleteRequest request,
            [FromServices] IHubContext<SignalRHelpers> hubContext)
        {
            request ??= new AboutUsDeleteRequest();
