...
public class ApiEndPointConsts
{
    ...
    {
        public const string AboutUsInsert = BaseRoute + "aboutus/insert";

        public const string AboutUsUpdate = BaseRoute + "aboutus/update";

        public const string AboutUsList = BaseRoute + "aboutus/list";

        public const string AboutUsDelete = BaseRoute + "aboutus/delete";

        public const string AboutUsGetById = BaseRoute + "aboutus/get_by_id";
