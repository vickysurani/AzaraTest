 ...
 *   https://datatables.net/download/#bs4/dt-1.11.4/r-2.2.9
 *
 * Included libraries:
...
(function( $, window, document, undefined ) {
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			 ...
			 *
			 *  @type string
			 *  @default Showing _START_ to _END_ from _TOTAL_ results
			 *
			 *  @dtopt Language
			 ...
			 *    } );
			 */
			"sInfo": "Showing _START_ to _END_ from _TOTAL_ results",
			 ...
			 *  @type string
			 *  @default Showing 0 to 0 from 0 results
			 *
			 *  @dtopt Language
			 ...
			 *    } );
			 */
			"sInfoEmpty": "Showing 0 to 0 from 0 results",
