namespace azara.client.Models.ShopProduct.Response
{
    public class PosInventoryResponse
    {
        ...
        public List<POSItemInventoryResponse> Details { get; set; }
    }

    public class POSItemInventoryResponse
    {
        ...
        public List<StoreListDetails> StoreListDetails { get; set; }

    }
    public class StoreListDetails
    {
